      ...
      if (dalleError.code === 'content_policy_violation') {
        ...
        const sanitizationResponse = await openai.chat.completions.create({
          ...
          messages: [
            {
              role: "system",
              content: "You are a content safety assistant for epic digital corruption adventure content. Your job is to make prompts safe for children aged 8-14 while keeping them COOL, EXCITING, and EPIC - never childish or babyish. Replace inappropriate content with awesome alternatives that kids think are amazing. Transform: weapons→digital tools/time magic items, violence→heroic digital challenges, scary monsters→awesome glitched creatures, destruction→spectacular digital corruption effects. Focus on digital corruption adventures, anime-style effects, time magic, gaming elements, internet cafés, and glitched reality in Enderby, BC. Strictly prohibit any nudity, sexual content, suggestive clothing, romantic posing, kissing, or adult themes; characters must be fully modest and age-appropriate. Keep it cinematic, dramatic, and thrilling with anime-fusion art style. Return ONLY the sanitized prompt, nothing else."
            },
            {
              role: "user",
        ...
        const sanitizedEnhancedPrompt = `Create an epic, high-quality image: ${sanitizedPrompt}. Style: realistic cartoon-anime fusion with glowing effects, soft shadows, dramatic lighting, and amazing digital corruption details. Make it look awesome and thrilling - the kind of image kids would want as their wallpaper. Keep all content completely family-friendly with no nudity, sexual content, or inappropriate material whatsoever. Focus on digital corruption adventures, anime-style effects, time magic, gaming elements, internet cafés, glitched reality in Enderby BC, and epic digital moments. Strictly avoid text on the images.`
